...
rows = [
    ...
    ("PUMP-HTW-03",     "IFM-012", "Hot Water Pump(HWP-03)",              "HWP-03",     "NYC Office Tower - Level B1",      "Partial - Approach 1", "Partial - Approach 1", 67.4),
    ("HTG-UNIT-3",      "IFM-P01", "Heating Coil Unit 3",                 "HC-3",       "Denver East Office",               "Partial - Approach 1", "Partial - Approach 1", 62.8),
    ("SUPPLY-FAN-B2",   "IFM-P02", "Supply Fan Unit SF-B2",               "SF-B2",      "Portland West Building",           "Partial - Approach 1", "Partial - Approach 1", 58.3),
    ("COND-WATER-PMP-1","IFM-P03", "Condenser Water Pump Loop 1",         "CWP-Loop-1", "Kansas City Service Depot",        "Partial - Approach 2", "Partial - Approach 2", 61.1),
    ("XHST-FAN-ROOF-4", "IFM-P04", "Exhaust Fan Roof Unit 04",            "EXH-RF-04",  "Omaha Manufacturing Plant",        "Partial - Approach 1", "Partial - Approach 1", 54.9),
    ("AIR-COMP-SHOP",   "IFM-P05", "Compressed Air System Shop Floor",    "AIR-COMP-01","Indianapolis Manufacturing",       "Partial - Approach 2", "Partial - Approach 2", 63.7),
